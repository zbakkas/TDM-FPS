  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord1.xy = TRANSFORM_TEX(in_v.vertex.xy, _MainTex);
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = clamp(u_xlat16_0, 0, 1);
          u_xlat1_d.xy = ((in_f.texcoord1.xy * float2(0.5, 0.5)) + float2(0.5, 0.5));
          u_xlat10_1.x = tex2D(_ClipTex, u_xlat1_d.xy).w;
          u_xlat16_9 = (u_xlat16_0.w * u_xlat10_1.x);
          out_f.color.xyz = u_xlat16_0.xyz;
          out_f.color.w = (u_xlat16_2.x * u_xlat16_9);
          return out_f;
      }
