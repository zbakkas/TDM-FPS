Shader "Custom/MultipleShader"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat10_0.xyz = tex2D(_BlendTex, in_f.texcoord.xy).xyz;
          u_xlat10_1.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          u_xlat0_d.xyz = ((u_xlat10_0.xyz * _Color.xyz) + u_xlat10_1.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = ((u_xlat10_0.xyz * _Color.xyz) + u_xlat10_2.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_2.xyz = tex2D(_BlendTex, in_f.texcoord.xy).xyz;
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          u_xlat2.xyz = ((u_xlat10_2.xyz * _Color.xyz) + u_xlat10_3.xyz);
